...
type UserServiceClient interface {
	...
	GetUsers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ResponseUser, error)
}
...
func (c *userServiceClient) GetUsers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ResponseUser, error) {
...
type UserServiceServer interface {
	...
	GetUsers(context.Context, *emptypb.Empty) (*ResponseUser, error)
}
...
func (UnimplementedUserServiceServer) GetUsers(context.Context, *emptypb.Empty) (*ResponseUser, error) {
